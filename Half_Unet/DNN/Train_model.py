...
def build_combined_model(input_size=(256, 1)):
    ...
    u_net = half_model(input_size=input_size)
...
if __name__ == "__main__":
    ...
    input_size = (256, 1)
    epochs = 100
    final_model_path = r'D:\MS_IITM\Research_work\PPG_SBP_DBP\Half_Unet\DNN\Final_model\combined_model.h5'
    checkpoint_dir = r'D:\MS_IITM\Research_work\PPG_SBP_DBP\Half_Unet\DNN\checkpoint_saved'
