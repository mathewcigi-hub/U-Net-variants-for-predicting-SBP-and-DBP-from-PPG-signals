...
def build_combined_model(input_size=(512, 1)):
    ...
    # DNN Classifier
    dense1 = tf.keras.layers.Dense(32)(flat)
    dense1 = Activation(e_swish)(dense1)
...
if __name__ == "__main__":
    ...
    folder = r'H:\HTIC\PulseDB\For_25k_data\PulseDB_25k_PPG_F_details\VitalDB_json_files_new_512\PPG_F_files'
    batch_size = 16    # batch size = 16/32
    input_size = (512, 1)
    epochs = 100
