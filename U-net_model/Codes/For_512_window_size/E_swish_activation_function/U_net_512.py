...
### For beta - Trainable learning parameter
beta = tf.Variable(initial_value=1.0, trainable=True) 

def e_swish(x):
    return beta * x * tf.keras.activations.sigmoid(x)
...
def unet_1d(pretrained_weights=None, input_size=(300, 1)):
    ...
    conv1 = Activation(e_swish)(conv1)
    ...
    conv2 = Activation(e_swish)(conv2)
    ...
    conv3 = Activation(e_swish)(conv3)
    ...
    conv4 = Activation(e_swish)(conv4)
    ...
    conv5 = Activation(e_swish)(conv5)
    ...
    conv10 = Activation(e_swish)(conv10)
