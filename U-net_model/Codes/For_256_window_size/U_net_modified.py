...
from keras.layers import Input, Conv1D, MaxPooling1D, UpSampling1D, concatenate, Dropout, Flatten, Dense
...
def unet_1d(pretrained_weights=None, input_size=(300, 1)):
    ...
    # Decoder
    up6 = Conv1D(256, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling1D(size=2)(drop5))
    ...
    up7 = Conv1D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling1D(size=2)(conv6))
    ...
    up8 = Conv1D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling1D(size=2)(conv7))
    ...
    up9 = Conv1D(32, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling1D(size=2)(conv8))
    ...
    conv10 = Conv1D(1, 3, activation='relu', padding='same', kernel_initializer='he_normal')(drop5)
