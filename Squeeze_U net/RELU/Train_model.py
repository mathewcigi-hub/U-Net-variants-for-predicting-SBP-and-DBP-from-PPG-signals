...
from Squeeze_U_net_256 import SqueezeUNet
...
def build_combined_model(input_size=(256, 1)):
    ...
    u_net = SqueezeUNet(input_size=input_size, num_classes=12)
...
if __name__ == "__main__":
    ...
    input_size = (256, 1)
    epochs = 100
    final_model_path = r'D:\MS_IITM\Research_work\PPG_SBP_DBP\Squeeze_U net\Mish\Final_model\combined_model.h5'
    checkpoint_dir = r'D:\MS_IITM\Research_work\PPG_SBP_DBP\Squeeze_U net\Mish\checkpoint_saved'
    ...
    early_stopping_callback = EarlyStopping(monitor='val_loss', patience=40, verbose=1, restore_best_weights=True)
